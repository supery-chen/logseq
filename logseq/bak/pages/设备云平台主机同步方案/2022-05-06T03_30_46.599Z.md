...
- |事件|画像key|
  ...
  |CCU_OPT_FAILED|stable.last_opt_complete_time=eventTime<br />stable.last_opt_complete_result=eventType<br />stable.no_link_frequency+1<br />stable.last_100_no_link_times.add(eventTime)<br />stable.last_50_opt_result_records.add(eventTime + "@" + eventType)|
  |CCU_OPT_TIMEOUT||
