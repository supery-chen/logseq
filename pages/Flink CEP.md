	...
	- ### 模式组
	  collapsed:: true
		...
		- ```java
		  ...
		  ```
	- ### 匹配后跳过策略
		- ((62569da0-b0aa-428f-993c-b900075df3bf))
-
- #### 模式的检测处理
	- ### 将模式应用到流上
		- ((62569f4a-e9c3-4153-956d-47d94281a1b5))
		- ((62569f56-7deb-4687-9a6a-109c430a18a8))
	- ### 处理匹配事件
		- ((6256ae3c-b89b-416e-8b28-b1db38abc0c2))
	- ### 处理超时事件
		- ((6256ae43-3de9-4e42-97f2-41d78e653ef9))
	- ### 处理迟到数据
		- ((6256ae59-8ff4-41ea-83ce-18c4d1dfff71))
-
- ## CEP的状态机实现
	- ((6256ae71-fbe6-43bb-8266-8d4f6f97e17d))
	-