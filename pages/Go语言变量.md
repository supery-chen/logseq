...
- ## 值类型和引用类型
	...
	- ![Replaced by Image Uploder](../assets/image_1644823579371_0.png)
	- 当使用等号=将一个变量的值赋值给另一个变量时，如`j = i`，实际上是在内存中将`i`的值进行了拷贝
	- ![Replaced by Image Uploder](../assets/image_1644823644880_0.png)
	...
	- ![Replaced by Image Uploder](../assets/image_1644823836457_0.png)
