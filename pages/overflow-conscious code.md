...
- 通过源码网上追溯，可以发现，minCapacity = oldCapacity + 1，所以，如果newCapacity发生溢出，因为oldCapacity的最大值为Integer.MAX_VALUE，所以newCapacity的最大值为-Integer.MAX_VALUE >> 1，所以newCapacity - minCapacity