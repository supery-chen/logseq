...
- |事件|画像key|
  ...
  |CCU_OPT_FAILED||
  |CCU_OPT_TIMEOUT||
  |CCU_ONLINE|basic.link=1<br />basic.link_type<br />stable.online_frequency+1<br />stable.last_online_time<br />stable.last_10_onoff_records|
